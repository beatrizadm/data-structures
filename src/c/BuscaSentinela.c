/*
*	Encontra um valor em um vetor sem precisar testar todos os valores dentro do laço
*/
...
int main(){
	...
	int vetor[TAM_VETOR+1]; // Declara o vetor com +1 pois é a posição que será utilizada pelo sentinela
